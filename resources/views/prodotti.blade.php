...
foreach ($cards as $key => $card) {  /* in ogni array il conteggio dell'indice parte da 0, se vogliamo il proseguimento
                                        del conteggio negli altri array dovremo mettere $key tra le parentesi*/
    if ($card['tipo'] == 'lunga') {
        $lunghe[$key] = $card;
                ...
                <div class="cards">
                    @foreach ($lunghe as $key => $prodotto)
                        <div class="card">
                            ...
                            <div class="hover">
                                <a href="{{route('prodotto.show', $key)}}"><h3>{{$prodotto['titolo']}}</h3></a>
